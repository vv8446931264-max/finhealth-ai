    ...
    <div className="min-h-screen bg-background">
        ...
        <div className="mx-auto grid max-w-6xl gap-10 px-4 py-20 md:grid-cols-2 md:py-28">
          <div>
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              <a href="#/assessment" className="inline-flex items-center gap-2 rounded-md bg-gold px-6 py-3 text-base font-semibold text-navy shadow-elegant transition hover:brightness-95">
                Get Your Score Now <ArrowRight className="h-4 w-4" />
              </a>
              <a href="#features" className="inline-flex items-center gap-2 rounded-md border border-white/20 px-6 py-3 text-base font-semibold text-white transition hover:bg-white/10">
                How it works
              </a>
            </div>
          ...
          <div className="relative">
            ...
            <div className="relative rounded-3xl border border-white/10 bg-white/5 p-6 backdrop-blur">
              ...
              <div className="mt-6 grid grid-cols-2 gap-3 text-xs">
                {[{ label: "Savings Rate", v: 88 }, { label: "Debt Health", v: 92 }, { label: "Investment", v: 74 }, { label: "Protection", v: 81 }].map((d) => (
      ...
      <section id="features" className="mx-auto max-w-6xl px-4 py-20">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-3 text-muted-foreground">A complete picture of your money — powered by IDBI Bank's financial intelligence.</p>
        </div>
        <div className="mt-12 grid gap-6 md:grid-cols-3">
          {[
            { icon: Gauge, title: "Instant Score", body: "Get a 0–100 Financial Health Score across 5 dimensions in under 2 minutes." },
            { icon: Sparkles, title: "Gemini AI Insights", body: "Personalised recommendations generated by Google Gemini 1.5 Flash, tailored to your exact numbers." },
            { icon: ListChecks, title: "30-Day Action Plan", body: "Three concrete steps to take this month to improve your score fast." },
          ].map((f) => (
            <div key={f.title} className="group rounded-2xl border border-border bg-card p-6 shadow-elegant transition hover:-translate-y-1">
        ...
        <div className="mt-16 grid gap-6 rounded-3xl bg-navy p-10 text-white md:grid-cols-3">
          {[
            ...
            { icon: Sparkles, k: "Gemini AI", v: "Real AI • Not just rules — powered by Google" },
          ].map((x) => (
            <div key={x.k} className="flex items-start gap-4">
              <x.icon className="mt-1 h-6 w-6 text-gold" />
              <div><div className="font-semibold">{x.k}</div><div className="text-sm text-white/70">{x.v}</div></div>
            </div>
          ))}
        </div>
      </section>
        ...
        <div className="overflow-hidden rounded-3xl border border-border bg-gradient-to-r from-navy to-[oklch(0.28_0.12_275)] p-10 text-white md:p-14">
          <div className="flex flex-col items-start justify-between gap-6 md:flex-row md:items-center">
            <div>
              ...
              <p className="mt-2 max-w-lg text-white/80">Answer 12 quick questions and unlock your AI-powered Financial Health Score.</p>
            </div>
            <a href="#/assessment" className="inline-flex items-center gap-2 rounded-md bg-gold px-6 py-3 text-base font-semibold text-navy transition hover:brightness-95">
