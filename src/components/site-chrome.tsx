    ...
    <header className="sticky top-0 z-40 border-b border-white/10 bg-navy/95 backdrop-blur">
      <div className="mx-auto flex h-16 max-w-6xl items-center justify-between px-4">
        ...
        <nav className="hidden gap-6 text-sm text-white/80 md:flex">
          ...
          <Link to="/assessment" className="hover:text-gold">Assessment</Link>
          <a href="#features" className="hover:text-gold">Features</a>
        </nav>
        <Link
          to="/assessment"
          className="rounded-md bg-gold px-4 py-2 text-sm font-semibold text-navy transition hover:brightness-95"
        >
          Get Score
        </Link>
      </div>
      ...
      <div className="mx-auto grid max-w-6xl gap-6 px-4 py-10 md:grid-cols-3">
        <div>
          ...
          <p className="mt-3 text-sm">
            An IDBI Bank initiative to help customers build stronger financial futures.
          </p>
        </div>
        <div>
